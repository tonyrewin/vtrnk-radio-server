...
def test_env_loading():
    ...
    # Critical variables with fallback for CI
    assert os.getenv('SOURCE_PASSWORD', 'dummy') is not None, "SOURCE_PASSWORD missing in .env"
    assert os.getenv('ADMIN_PASSWORD', 'dummy') is not None, "ADMIN_PASSWORD missing in .env"
